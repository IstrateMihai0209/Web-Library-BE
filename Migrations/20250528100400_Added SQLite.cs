        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoreAboutAuthor = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ...
                    ReadBooksModelId = table.Column<int>(type: "INTEGER", nullable: true),
                    ReadingHistoryModelId = table.Column<int>(type: "INTEGER", nullable: true),
                    WishlistModelId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ReadBooksModelId,
                        principalTable: "ReadBooks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_ReadingHistories_ReadingHistoryModelId",
                        column: x => x.ReadingHistoryModelId,
                        principalTable: "ReadingHistories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_ReadingHistoryModelId",
                table: "Books",
                column: "ReadingHistoryModelId");
